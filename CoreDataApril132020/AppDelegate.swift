...
//  CoreDataApril132020
//
//  Created by Margiett Gil on 4/13/20.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        /*
         ...
         container holds the data model
         if you want to access anything in that data model you have to have access to the NSPersistentContainer
        ...
        */
        let container = NSPersistentContainer(name: "CoreDataApril132020")
